      ...
      <div className="bg-white rounded-2xl border border-stone-200 shadow-sm overflow-hidden">
        <ul className="divide-y divide-stone-100">
          {mutations?.length === 0 ? (
            ...
            <li key={m.id} className="flex flex-col md:flex-row md:items-center justify-between p-4 sm:p-6 hover:bg-stone-50 transition-colors gap-4">
              <div className="flex items-start md:items-center gap-3 sm:gap-4 flex-1 overflow-hidden">
                ...
                <div className="flex-1 min-w-0 pt-0.5 md:pt-0">
                  <div className="flex items-center gap-2 flex-wrap">
                    <h3 className="font-semibold text-stone-900 break-words" title={m.description || m.type} style={{ wordBreak: "break-word" }}>{m.description || m.type}</h3>
